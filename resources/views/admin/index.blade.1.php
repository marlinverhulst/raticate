  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Admin <sup>raticate</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" data-toggle="modal" data-target="#exampleModal" href="">Users</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">Open Jobs</a>
            <a class="collapse-item" href="utilities-border.html">Jobs</a>
            <a class="collapse-item" href="utilities-animation.html">User</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="login.html">Jobs</a>
            <a class="collapse-item" href="register.html">users</a>
           
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Export data:</h6>
            <a class="collapse-item" href="404.html">to pdf </a>
            <a class="collapse-item" href="blank.html">to cvs</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; M-soft 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
